...
void Benchmark::SingleAllocation(Allocator<int>* allocator, const std::size_t size) {
  ...
  BenchmarkResults results = buildResults(m_nOperations, std::move(TimeElapsed));

  PrintResults(results);
}
/*
void Benchmark::SingleFree(Allocator<int>* allocator, const std::size_t size, const std::size_t alignment) {
...
const BenchmarkResults Benchmark::buildResults(std::size_t nOperations, std::chrono::milliseconds&& elapsedTime) const {
